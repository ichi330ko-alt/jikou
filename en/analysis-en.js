(() => {
  ...
  function selectedTimezone(){ const el = byId("timezone-offset"); const v = Number(el?.value); return Number.isFinite(v) ? v : JAPAN_TIMEZONE; }
  ...
  async function handleSubmit(event) {
    ...
    if (!form.reportValidity()) {
      ...
      setStatus("Please check the information you entered.", true);
    ...
    try {
      ...
      setStatus("Calculating your 12 Seats…");
      ...
      setStatus(
        ...
        error.message || "An error occurred while calculating your reading.",
